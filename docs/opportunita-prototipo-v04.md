...
Ai quattro canali discovery v0.3 si aggiungono:
...
Questi canali restano **discovery**: non possono promuovere automaticamente una scheda nella preview. Per l'output serve comunque una fonte primaria ufficiale, la verifica del ruolo comunale e la matrice Comune-per-Comune.

## Famiglie minime coperte

L'audit richiede almeno una fonte configurata per ciascuna famiglia:
