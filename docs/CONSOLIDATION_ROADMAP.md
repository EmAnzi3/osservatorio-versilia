...
Nota A5.5 — lotto 1 IN_PROGRESS: propagazione controllata del golden master tematico a `confronta/economia/`. Prima dell’attivazione lo shell A5 viene reso parametrico: testi dipendenti dal tema, extra contestuali e accenti cromatici usano ruoli DS2 condivisi invece di hard-code Demografia. L’Atlante attività economiche resta esplicitamente fuori dal lotto. Il gate browser confronta la geometria Economia con il golden Demografia e verifica desktop/mobile, accenti tema, assenza di contenuti Demografia e 7/7 card comunali. Le schede comunali Economia non fanno parte di questo primo commit.
