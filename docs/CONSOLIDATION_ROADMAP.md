...
Nota A5.5 — lotto 2 IN_PROGRESS: propagazione controllata a `confronta/lavoro/`. Il gate confronta la geometria con il golden Demografia, verifica l’accento tema, attraversa tutti gli indicatori Lavoro presenti nella sidebar e controlla anche le superfici età/sesso quando presenti; verifica inoltre la shell mobile a 390 px. Nessuna scheda comunale Lavoro viene modificata in questo lotto.
