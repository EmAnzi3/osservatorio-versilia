...
1. Aprire la PR della seconda tranche C.
2. Portare A3 Enrichment Audit, Quick e Full GREEN sul final head.
3. Verificare nel log A3 il conteggio esatto **1.812 / 213** e le 7 coppie `NOT_APPLICABLE`.
4. Fermarsi prima del merge.
5. Dopo merge autorizzato, ricostruire le 13 C residue effettive e chiuderle per sottogruppi semantici omogenei.
