...
Versione dati corrente: **v1.23.0** — 28 agosto 2026.
...
- 7 schede comunali;
- 11 aree tematiche;
- 162 indicatori nel catalogo canonico: 158 con valori incorporati e 4 climatici con storici separati;
...
- `indicatori/`: 158 pagine canoniche generate in build, una per indicatore con dati incorporati;
- `data/site-data.json`: catalogo canonico dei 162 indicatori, con dati incorporati per 158 e riferimenti ai file storici separati per i 4 climatici;
...
Il catalogo e i metadati dei 162 indicatori sono centralizzati in `data/site-data.json`. Gli storici climatici più pesanti restano nei file dedicati richiamati da `dataStorage`. Per aggiornamenti strutturali conviene modificare o rigenerare questi dati mantenendo per ogni indicatore:
...
- valida tutti i 162 indicatori canonici, la ripartizione fra 158 valori incorporati e 4 storici climatici separati e la coerenza della copertura dichiarata;
