...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        require('peso sul totale versilia' in total_position.lower(), f'Intestazione recupero totale inattesa: {total_position!r}')
        ...
        require('contributo attribuito in versilia' in dait_position.lower(), f'Intestazione DAIT inattesa: {dait_position!r}')
