...
def main() -> None:
    require(SITE['version'] == 'v1.17.0', 'Versione dati inattesa')
    require(len(SITE['metrics']) == 143, f"Metriche inattese: {len(SITE['metrics'])}")
    require(REGISTRY['expectedMetricCount'] == 143, 'Registry totale inatteso')
    require(REGISTRY['expectedInlineMetricCount'] == 139, 'Registry inline inatteso')
