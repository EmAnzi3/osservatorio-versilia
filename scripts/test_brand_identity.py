...
def main() -> None:
    ...
    for page in pages:
        ...
        require("assets/brand.css?v=20260820-ov2" in text, f"CSS brand assente in {page}")
        ...
        require("favicon.svg?v=20260820-ov2" in text, f"Favicon non cache-bustata in {page}")
