#!/usr/bin/env python3
"""Contratto pubblico e metodologico della release v1.16.0."""
...
def main() -> None:
    ...
    assert 'UX_ASSET_VERSION = "20260824-v116"' in build_safe
    assert 'APP_BUNDLE_ASSET_VERSION = "20260824-v116"' in build_brand
    assert "ov-pwa-20260824-v116" in service_worker
