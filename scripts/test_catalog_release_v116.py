...
def main():
    ...
    assert "case 'km'" in app0 and "case 'kmIntervention'" in app0 and '2026.08.31-v1.26.0' in app5 and '175 indicatori complessivi' in app5 and '2026.08.30-v1.25.0' in app5
    chart=(ROOT/'assets/app-parts/03.txt').read_text(encoding='utf-8'); assert 'part.count === null || part.count === undefined' in chart
    readme=(ROOT/'README.md').read_text(encoding='utf-8'); assert '**v1.26.0** — 31 agosto 2026' in readme and '175 indicatori' in readme and '171 con valori incorporati' in readme
