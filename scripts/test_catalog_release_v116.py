#!/usr/bin/env python3
"""Contratto pubblico e metodologico della release v1.23.0."""
...
def main() -> None:
    ...
    assert "**v1.23.0** — 28 agosto 2026" in readme
    assert "162 indicatori" in readme and "158 con valori incorporati" in readme
    ...
    assert 'UX_ASSET_VERSION = "20260828-v123-coast-ui1"' in build_safe
    assert 'HISTORY_ASSET_VERSION = "20260828-v123-coast-ui1"' in build_safe
    assert 'APP_BUNDLE_ASSET_VERSION = "20260828-v123-coast-ui1"' in build_brand
    ...
    assert "const VERSION = '20260828-v123-coast-ui1';" in export_script
