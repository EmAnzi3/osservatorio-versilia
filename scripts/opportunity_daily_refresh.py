...
La scansione è live, ma non salta i gate: continuità, backtest, copertura e
verifiche dirette devono essere verdi. Le fonti di puro discovery non possono
pubblicare da sole; eventuali candidati restano nella coda interna del report.
"""
