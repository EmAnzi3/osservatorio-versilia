...
assert 'HISTORY_ASSET_VERSION = "20260827-v121-history-ui6"' in BUILD_SAFE, "Cache-buster degli asset storici non aggiornato"
assert 'script in {"ux-history-core.js", "ux-history.js"}' in BUILD_SAFE, "ux-history.js non usa il cache-buster storico dedicato"
assert "const HOTFIX_VERSION = '20260827-v121-history-ui6';" in UX_HISTORY, "Fetch dati dell'enhancer storico non versionato"
...
assert "ov-pwa-20260827-v121-tooltip-ui6" in SW, "Versione service worker non aggiornata"
